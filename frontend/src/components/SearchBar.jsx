    ...
    <div className="w-full px-4 md:px-10 mb-16 relative z-20">
      ...
      <div className="bg-zinc-950 p-2 shadow-2xl w-full border border-zinc-800">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-5 gap-2">
          ...
          <button type="submit" className="bg-red-600 hover:bg-white text-white hover:text-black font-black uppercase text-xs tracking-widest transition-all duration-300 py-4 shadow-lg active:scale-95">
            Find Auto Parts
          </button>
